...
- Name: monitor.spec.ts >> 系统监控 - 服务监控 >> 服务监控展示 CPU / 内存信息
- Location: playwright/tests/monitor.spec.ts:123:3
...
Locator: getByText(/CPU|cpu|内存|Memory/i).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/CPU|cpu|内存|Memory/i).first()
