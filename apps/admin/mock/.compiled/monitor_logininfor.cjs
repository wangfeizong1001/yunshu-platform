...
// mock/routes/monitor/logininfor.ts
var logininfor_exports = {};
__export(logininfor_exports, {
  default: () => logininfor_default
});
module.exports = __toCommonJS(logininfor_exports);
...
var logininfor_default = [
   ...
   */
  {
    ...
    response: async ({
      ...
      if (userName) {
        list = list.filter(
          (log) => log.userName.includes(userName) || log.loginAccount.includes(userName)
        );
      }
      if (status) {
