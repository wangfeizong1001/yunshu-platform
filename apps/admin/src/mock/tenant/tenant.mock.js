...
export function getTenantPage(params) {
    ...
    if (keyword) {
        ...
        filtered = filtered.filter(t => t.tenantName.toLowerCase().includes(kw) ||
...
/** 更新租户 */
export function updateTenantById(tenantId, data) {
...
/** 修改租户状态 */
export function changeTenantStatusById(tenantId, status) {
...
//# sourceMappingURL=tenant.mock.js.map