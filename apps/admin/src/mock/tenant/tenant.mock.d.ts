...
/** 新增租户 */
export declare function createTenant(data: Omit<Tenant, 'tenantId' | 'createTime' | 'updateTime'>): Tenant;
/** 更新租户 */
export declare function updateTenantById(tenantId: number, data: Partial<Omit<Tenant, 'tenantId' | 'createTime'>>): Tenant | undefined;
/** 删除租户 */
export declare function deleteTenantById(tenantId: number): boolean;
/** 修改租户状态 */
export declare function changeTenantStatusById(tenantId: number, status: '0' | '1' | '2'): Tenant | undefined;
