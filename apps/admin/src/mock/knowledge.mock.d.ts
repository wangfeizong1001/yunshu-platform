...
export declare function updateMockKnowledge(knowledgeId: number, data: Partial<KnowledgeInfo>): KnowledgeInfo | undefined;
...
export declare function updateMockCategory(categoryId: number, data: Partial<KnowledgeCategory>): KnowledgeCategory | undefined;
