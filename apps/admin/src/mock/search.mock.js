 ...
 * 获取热门搜索
 */
export function getMockHotSearches(limit = 10) {
  return {
 ...
 * 获取搜索历史
 */
export function getMockSearchHistory(limit = 20) {
  return mockSearchHistory.slice(0, limit);
}
/**
 * 保存搜索历史
 */
export function saveMockSearchHistory(data) {
  const newItem = {
    id: Date.now(),
 ...
 * 删除搜索历史
 */
export function deleteMockSearchHistory(id) {
 ...
 * 清空搜索历史
 */
export function clearMockSearchHistory() {
