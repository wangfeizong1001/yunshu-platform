 ...
 * 数据字典 Mock 数据
 */
import type { SysDictType, SysDictTypePageResp, SysDictData, SysDictDataPageResp } from '@yunshu/shared';
...
export declare function updateMockDictType(dictId: number, data: Partial<SysDictType>): SysDictType | undefined;
...
export declare function updateMockDictData(dictCode: number, data: Partial<SysDictData>): SysDictData | undefined;
