...
// 字典类型 Mock 数据
export const mockDictTypeList: SysDictType[] = [
  {
    dictId: 1,
    dictName: '用户性别',
...
// 新增字典类型 Mock
export function addMockDictType(data: Partial<SysDictType>): SysDictType {
...
// 新增字典数据 Mock
export function addMockDictData(data: Partial<SysDictData>): SysDictData {
