...
// 更新知识库文档 Mock
export function updateMockKnowledge(knowledgeId: number, data: Partial<KnowledgeInfo>): KnowledgeInfo | undefined {
...
// 更新知识库分类 Mock
export function updateMockCategory(categoryId: number, data: Partial<KnowledgeCategory>): KnowledgeCategory | undefined {
