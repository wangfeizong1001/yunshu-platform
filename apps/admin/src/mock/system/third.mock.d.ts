 ...
 * 第三方登录 Mock 数据
 */
import type { ThirdLoginConfig, ThirdLoginLog, ThirdLoginLogPageResp, ThirdAuthorizeResp } from '@yunshu/shared';
...
export declare function handleMockThirdCallback(platform: string, code: string, _state?: string): {
    token: string;
    isBind: boolean;
};
