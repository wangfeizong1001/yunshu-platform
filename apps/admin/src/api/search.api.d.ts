...
export declare function searchUsers(
  params: Omit<SearchQueryParams, 'type'>,
): Promise<SearchResponse>;
/**
 * 搜索部门
 */
export declare function searchDepts(
  params: Omit<SearchQueryParams, 'type'>,
): Promise<SearchResponse>;
/**
 * 搜索菜单
 */
export declare function searchMenus(
  params: Omit<SearchQueryParams, 'type'>,
): Promise<SearchResponse>;
/**
 * 搜索角色
 */
export declare function searchRoles(
  params: Omit<SearchQueryParams, 'type'>,
): Promise<SearchResponse>;
/**
 * 搜索公告
 */
export declare function searchNotices(
  params: Omit<SearchQueryParams, 'type'>,
): Promise<SearchResponse>;
/**
 * 搜索知识
 */
export declare function searchKnowledge(
  params: Omit<SearchQueryParams, 'type'>,
): Promise<SearchResponse>;
/**
 * 获取热门搜索
