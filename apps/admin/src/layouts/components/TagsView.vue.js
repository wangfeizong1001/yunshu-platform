...
/** @type {__VLS_StyleScopedClasses['el-icon-close']} */ // CSS variable injection
...
for (const [tag] of __VLS_getVForSourceType(__VLS_ctx.visitedViews)) {
  ...
  if (!__VLS_ctx.isAffix(tag)) {
    __VLS_asFunctionalElement(
      ...
      ...{
        onClick: (...[$event]) => {
          if (!!__VLS_ctx.isAffix(tag)) return;
...
__VLS_asFunctionalDirective(__VLS_directives.vShow)(
  null,
  { ...__VLS_directiveBindingRestFields, value: __VLS_ctx.visible },
  null,
  null,
);
__VLS_asFunctionalElement(
...
if (!__VLS_ctx.isAffix(__VLS_ctx.selectedTag)) {
  __VLS_asFunctionalElement(
    ...
    ...{
      onClick: (...[$event]) => {
        if (!!__VLS_ctx.isAffix(__VLS_ctx.selectedTag)) return;
...
/** @type {__VLS_StyleScopedClasses['tags-view']} */ /** @type {__VLS_StyleScopedClasses['tags-view-wrapper']} */ /** @type {__VLS_StyleScopedClasses['tags-view-item']} */ /** @type {__VLS_StyleScopedClasses['el-icon-close']} */ /** @type {__VLS_StyleScopedClasses['contextmenu']} */ var __VLS_dollars;
