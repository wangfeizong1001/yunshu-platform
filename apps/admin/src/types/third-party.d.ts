...
declare module 'vuedraggable' {
  ...
  export interface DraggableOptions {
    ...
    /** 分组 */
    group?: string | { name: string; pull?: boolean | 'clone' | ((to: unknown, from: unknown, el: HTMLElement) => boolean | number); put?: boolean | boolean[] | ((to: unknown, from: unknown, el: HTMLElement) => boolean) }
    /** 动画 */
    animation?: number
    /** 是否禁用 */
    disabled?: boolean
...
declare module 'xlsx' {
  ...
  export const read: (data: ArrayBuffer | ArrayBufferView | string, opts?: ParsingOptions) => WorkBook
  ...
  export const writeFileAsync: (wb: WorkBook, filename: string, opts?: WritingOptions) => Promise<void>
}
...
declare module 'jspdf' {
  ...
  export interface TextOptions {
    ...
    /** 垂直对齐 */
    baseline?: 'top' | 'hanging' | 'middle' | 'bottom' | 'ideographic' | 'alphabetic' | 'mathematical'
    /** 字符间距 */
    charSpace?: number
    /** 旋转角度 */
    angle?: number
