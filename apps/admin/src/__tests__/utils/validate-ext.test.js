...
import { validate, safeValidate, createTypeGuard, isApiResponseSuccess, isPaginatedResponse, isPaginationMeta, usernameSchema, passwordSchema, phoneSchema, emailSchema } from '@/utils/validate';
describe('validate utils - schema / 辅助函数', () => {
    ...
    it('isPaginatedResponse 正确判断', () => {
        ...
        expect(isPaginatedResponse({ success: true, data: 'not array' })).toBe(false);
...
//# sourceMappingURL=validate-ext.test.js.map