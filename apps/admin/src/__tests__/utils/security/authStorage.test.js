...
import { getToken, setToken, removeToken, hasToken, setUserProfile, getUserProfile, clearUserProfile, clearAuth, } from '@/utils/security/authStorage';
describe('utils/security/authStorage', () => {
    ...
    describe('用户资料管理', () => {
        ...
        it('损坏的 JSON 资料读取返回 null', () => {
            ...
            Cookies.set('yunshu_profile', '{bad-json');
            expect(getUserProfile()).toBeNull();
        });
    });
    describe('一键登出', () => {
...
//# sourceMappingURL=authStorage.test.js.map