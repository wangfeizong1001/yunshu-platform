...
export declare const useTagsViewStore: import("pinia").StoreDefinition<"tagsView", Pick<{
    visitedViews: {
        value: TagView[];
    };
    cachedViews: {
    ...
    delCachedView: (view: TagView) => void;
    updateVisitedView: (view: TagView) => void;
}, "addVisitedView" | "delVisitedView" | "delOtherViews" | "delAllViews" | "delCachedView" | "updateVisitedView">>;
