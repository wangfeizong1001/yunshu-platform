            ...
            <el-form label-width="100px">
              ...
              <div class="column-list">
                <div v-for="(column, index) in tableConfig.columns" :key="index" class="column-item">
                  <el-input v-model="column.title" placeholder="列标题" style="width: 120px; margin-right: 8px" />
                  <el-input v-model="column.field" placeholder="字段名" style="width: 120px; margin-right: 8px" />
                  <el-input-number
                    ...
                    placeholder="宽度"
                  />
                  <el-button type="danger" size="small" :icon="Delete" circle @click="removeTableColumn(index)" />
                </div>
              </div>
            </el-form>
          </el-tab-pane>
