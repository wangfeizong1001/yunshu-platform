...
const getReportStatusTagType = (val) => val === REPORT_STATUS_NORMAL ? 'success' : 'danger';
const getReportStatusLabel = (val) => val === REPORT_STATUS_NORMAL ? '正常' : '停用';
...
__VLS_139.slots.default;
{
    ...
    const __VLS_141 = __VLS_asFunctionalComponent(__VLS_140, new __VLS_140({
        type: (__VLS_ctx.getReportStatusTagType(row.status)),
    }));
    const __VLS_142 = __VLS_141({
        type: (__VLS_ctx.getReportStatusTagType(row.status)),
    }, ...__VLS_functionalComponentArgsRest(__VLS_141));
    __VLS_143.slots.default;
    (__VLS_ctx.getReportStatusLabel(row.status));
    var __VLS_143;
}
var __VLS_139;
...
const __VLS_252 = __VLS_asFunctionalComponent(__VLS_251, new __VLS_251({
    value: (__VLS_ctx.REPORT_STATUS_NORMAL),
}));
...
const __VLS_256 = __VLS_asFunctionalComponent(__VLS_255, new __VLS_255({
    value: (__VLS_ctx.REPORT_STATUS_DISABLED),
}));
...
const __VLS_self = (await import('vue')).defineComponent({
    setup() {
        return {
            ...
            Plus: Plus,
            Delete: Delete,
            REPORT_STATUS_NORMAL: REPORT_STATUS_NORMAL,
            REPORT_STATUS_DISABLED: REPORT_STATUS_DISABLED,
            getReportStatusTagType: getReportStatusTagType,
