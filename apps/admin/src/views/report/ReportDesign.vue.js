...
if (__VLS_ctx.reportType === 'table') {
  ...
  for (const [column, index] of __VLS_getVForSourceType(__VLS_ctx.tableConfig.columns)) {
    ...
    const __VLS_183 = {
      onClick: (...[$event]) => {
        if (!(__VLS_ctx.reportType === 'table')) return;
...
/** @type {typeof __VLS_ctx.previewRef} */ if (__VLS_ctx.reportType === 'chart') {
  __VLS_asFunctionalElement(
    __VLS_intrinsicElements.div,
    __VLS_intrinsicElements.div,
  )({
...
var __VLS_211;
/** @type {__VLS_StyleScopedClasses['report-design']} */ /** @type {__VLS_StyleScopedClasses['toolbar']} */ /** @type {__VLS_StyleScopedClasses['toolbar-left']} */ /** @type {__VLS_StyleScopedClasses['title']} */ /** @type {__VLS_StyleScopedClasses['toolbar-right']} */ /** @type {__VLS_StyleScopedClasses['main-content']} */ /** @type {__VLS_StyleScopedClasses['left-panel']} */ /** @type {__VLS_StyleScopedClasses['column-list']} */ /** @type {__VLS_StyleScopedClasses['column-item']} */ /** @type {__VLS_StyleScopedClasses['data-config']} */ /** @type {__VLS_StyleScopedClasses['data-header']} */ /** @type {__VLS_StyleScopedClasses['data-editor']} */ /** @type {__VLS_StyleScopedClasses['right-panel']} */ /** @type {__VLS_StyleScopedClasses['preview-header']} */ /** @type {__VLS_StyleScopedClasses['preview-content']} */ /** @type {__VLS_StyleScopedClasses['chart-container']} */ /** @type {__VLS_StyleScopedClasses['table-container']} */ /** @type {__VLS_StyleScopedClasses['preview-dialog']} */ var __VLS_dollars;
