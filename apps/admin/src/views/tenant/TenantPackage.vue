<template>
  <el-dialog v-model="visible" title="租户套餐配置" width="600px" destroy-on-close>
    <el-alert
      v-if="currentTenant"
    ...
    <el-form :model="formData" label-width="100px">
      ...
      <el-form-item label="用户上限">
        <el-input-number v-model="formData.userLimit" :min="1" :max="999999" style="width: 100%" />
      </el-form-item>
    </el-form>
