...
for (const [route] of __VLS_getVForSourceType((__VLS_ctx.menuRoutes))) {
    ...
    // @ts-ignore
    const __VLS_8 = __VLS_asFunctionalComponent(SidebarItem, new SidebarItem({
        key: (route.path),
        item: (route),
        basePath: (route.path),
    }));
...
// @ts-ignore
const __VLS_11 = __VLS_asFunctionalComponent(Hamburger, new Hamburger({
    ...{ 'onToggle': {} },
...
/** @type {[typeof Search, ]} */ ;
// @ts-ignore
const __VLS_21 = __VLS_asFunctionalComponent(Search, new Search({
    ...{ class: "navbar-item" },
}));
...
// @ts-ignore
const __VLS_24 = __VLS_asFunctionalComponent(FullScreen, new FullScreen({
    ...{ class: "navbar-item" },
}));
...
// @ts-ignore
const __VLS_27 = __VLS_asFunctionalComponent(LanguageSwitch, new LanguageSwitch({
    ...{ class: "navbar-item" },
}));
