...
import { getGenTablePage, deleteGenTable } from '@/api/tool/gen.api';
...
const handleSelectionChange = (selection) => {
    selectedIds.value = selection.map((item) => item.tableName).filter((n) => !!n);
};
const handleImport = () => {
...
const handleDelete = async (row) => {
    try {
        ...
        await deleteGenTable(row.tableName);
...
var __VLS_155;
var __VLS_75;
/** @type {[typeof GenImport, ]} */ ;
// @ts-ignore
const __VLS_161 = __VLS_asFunctionalComponent(GenImport, new GenImport({
    ...{ 'onSuccess': {} },
...
// @ts-ignore
const __VLS_168 = __VLS_asFunctionalComponent(GenPreview, new GenPreview({
