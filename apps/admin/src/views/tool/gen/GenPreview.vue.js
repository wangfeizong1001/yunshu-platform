...
const highlightCode = (code, _lang) => {
    ...
    const keywords = [
        ...
        'continue', 'try', 'catch', 'finally', 'throw', 'class', 'extends', 'implements',
        'interface', 'type', 'enum', 'public', 'private', 'protected', 'static',
        'final', 'abstract', 'async', 'await', 'new', 'this', 'super', 'null',
        'undefined', 'true', 'false', 'void', 'number', 'string', 'boolean',
        'any', 'never', 'unknown', 'object', 'package', 'class', 'interface',
        'extends', 'implements', 'public', 'private', 'protected', 'static',
        'final', 'abstract', 'synchronized', 'volatile', 'transient', 'native',
        'strictfp', 'throws', 'throw', 'try', 'catch', 'finally', 'if', 'else',
        'switch', 'case', 'default', 'for', 'while', 'do', 'break', 'continue',
        'return', 'goto', 'const', 'package', 'import', 'public', 'private',
        'protected', 'static', 'final', 'abstract', 'class', 'interface',
        'extends', 'implements', 'native', 'synchronized', 'transient', 'volatile',
        'strictfp', 'throws', 'throw', 'try', 'catch', 'finally', 'if', 'else',
        'switch', 'case', 'default', 'for', 'while', 'do', 'break', 'continue',
        'return', 'goto', 'const'
    ];
...
const loadPreviewData = async () => {
    ...
    try {
        const config = {
            ...
            genType: props.config?.generateType || 'single',
            genPath: props.config?.genPath || '',
            businessName: props.config?.businessName || '',
            functionName: props.config?.functionName || '',
            treeCode: props.config?.treeCodeField,
            treeParentCode: props.config?.treeParentCodeField,
            treeName: props.config?.treeNameField
        };
...
/** @type {typeof __VLS_ctx.codeContentRef} */ ;
if (__VLS_ctx.currentFile) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.pre, __VLS_intrinsicElements.pre)({});
    /** @type {[typeof SafeHtml, ]} */ ;
    // @ts-ignore
    const __VLS_57 = __VLS_asFunctionalComponent(SafeHtml, new SafeHtml({
        html: (__VLS_ctx.highlightedCode),
    }));
...
/** @type {__VLS_StyleScopedClasses['file-list-header']} */ ;
/** @type {__VLS_StyleScopedClasses['file-list-content']} */ ;
