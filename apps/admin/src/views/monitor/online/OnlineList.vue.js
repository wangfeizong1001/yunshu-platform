...
const handleBatchForceLogout = async () => {
  try {
    await ElMessageBox.confirm(
      `确认强制下线选中的 ${selectedIds.value.length} 名用户吗？`,
      '提示',
      { type: 'warning' },
    );
...
/** @type {[typeof __VLS_components.Cellphone, ]} */ // @ts-ignore
...
var __VLS_171;
var __VLS_111;
/** @type {__VLS_StyleScopedClasses['page-container']} */ /** @type {__VLS_StyleScopedClasses['stats-row']} */ /** @type {__VLS_StyleScopedClasses['stat-card']} */ /** @type {__VLS_StyleScopedClasses['stat-info']} */ /** @type {__VLS_StyleScopedClasses['stat-value']} */ /** @type {__VLS_StyleScopedClasses['stat-label']} */ /** @type {__VLS_StyleScopedClasses['stat-icon']} */ /** @type {__VLS_StyleScopedClasses['total']} */ /** @type {__VLS_StyleScopedClasses['stat-card']} */ /** @type {__VLS_StyleScopedClasses['stat-info']} */ /** @type {__VLS_StyleScopedClasses['stat-value']} */ /** @type {__VLS_StyleScopedClasses['stat-label']} */ /** @type {__VLS_StyleScopedClasses['stat-icon']} */ /** @type {__VLS_StyleScopedClasses['pc']} */ /** @type {__VLS_StyleScopedClasses['stat-card']} */ /** @type {__VLS_StyleScopedClasses['stat-info']} */ /** @type {__VLS_StyleScopedClasses['stat-value']} */ /** @type {__VLS_StyleScopedClasses['stat-label']} */ /** @type {__VLS_StyleScopedClasses['stat-icon']} */ /** @type {__VLS_StyleScopedClasses['mobile']} */ /** @type {__VLS_StyleScopedClasses['search-card']} */ /** @type {__VLS_StyleScopedClasses['toolbar-card']} */ /** @type {__VLS_StyleScopedClasses['toolbar']} */ /** @type {__VLS_StyleScopedClasses['toolbar-left']} */ /** @type {__VLS_StyleScopedClasses['toolbar-right']} */ /** @type {__VLS_StyleScopedClasses['table-card']} */ /** @type {__VLS_StyleScopedClasses['pagination-container']} */ var __VLS_dollars;
