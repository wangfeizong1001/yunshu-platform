...
/** 登录状态 tag 类型 */
const getLoginStatusTagType = (val) => val === LOGIN_STATUS_SUCCESS ? 'success' : 'danger';
/** 登录状态文本 */
const getLoginStatusLabel = (val) => val === LOGIN_STATUS_SUCCESS ? '成功' : '失败';
...
__VLS_123.slots.default;
{
    ...
    const __VLS_125 = __VLS_asFunctionalComponent(__VLS_124, new __VLS_124({
        type: (__VLS_ctx.getLoginStatusTagType(row.status)),
    }));
    const __VLS_126 = __VLS_125({
        type: (__VLS_ctx.getLoginStatusTagType(row.status)),
    }, ...__VLS_functionalComponentArgsRest(__VLS_125));
    __VLS_127.slots.default;
    (__VLS_ctx.getLoginStatusLabel(row.status));
    var __VLS_127;
}
var __VLS_123;
...
const __VLS_202 = __VLS_asFunctionalComponent(__VLS_201, new __VLS_201({
    type: (__VLS_ctx.getLoginStatusTagType(__VLS_ctx.currentRow?.status)),
}));
const __VLS_203 = __VLS_202({
    type: (__VLS_ctx.getLoginStatusTagType(__VLS_ctx.currentRow?.status)),
}, ...__VLS_functionalComponentArgsRest(__VLS_202));
__VLS_204.slots.default;
(__VLS_ctx.getLoginStatusLabel(__VLS_ctx.currentRow?.status));
var __VLS_204;
var __VLS_200;
...
const __VLS_self = (await import('vue')).defineComponent({
    setup() {
        return {
            ...
            Delete: Delete,
            Download: Download,
            getLoginStatusTagType: getLoginStatusTagType,
            getLoginStatusLabel: getLoginStatusLabel,
            loading: loading,
            tableData: tableData,
            total: total,
