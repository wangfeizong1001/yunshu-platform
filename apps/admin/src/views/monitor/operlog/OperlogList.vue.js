...
const getOperlogStatusTagType = (val) => val === OPERLOG_STATUS_SUCCESS ? 'success' : 'danger';
const getOperlogStatusLabel = (val) => val === OPERLOG_STATUS_SUCCESS ? '成功' : '失败';
...
__VLS_200.slots.default;
{
    ...
    const __VLS_202 = __VLS_asFunctionalComponent(__VLS_201, new __VLS_201({
        type: (__VLS_ctx.getOperlogStatusTagType(row.status)),
    }));
    const __VLS_203 = __VLS_202({
        type: (__VLS_ctx.getOperlogStatusTagType(row.status)),
    }, ...__VLS_functionalComponentArgsRest(__VLS_202));
    __VLS_204.slots.default;
    (__VLS_ctx.getOperlogStatusLabel(row.status));
    var __VLS_204;
}
var __VLS_200;
...
const __VLS_291 = __VLS_asFunctionalComponent(__VLS_290, new __VLS_290({
    type: (__VLS_ctx.getOperlogStatusTagType(__VLS_ctx.currentRow?.status || '')),
}));
const __VLS_292 = __VLS_291({
    type: (__VLS_ctx.getOperlogStatusTagType(__VLS_ctx.currentRow?.status || '')),
}, ...__VLS_functionalComponentArgsRest(__VLS_291));
__VLS_293.slots.default;
(__VLS_ctx.getOperlogStatusLabel(__VLS_ctx.currentRow?.status || ''));
var __VLS_293;
var __VLS_289;
...
const __VLS_self = (await import('vue')).defineComponent({
    setup() {
        return {
            ...
            Delete: Delete,
            Download: Download,
            getOperlogStatusTagType: getOperlogStatusTagType,
            getOperlogStatusLabel: getOperlogStatusLabel,
            loading: loading,
            tableData: tableData,
            total: total,
