...
/** 任务并发执行状态 tag 类型 */
const getConcurrentTagType = (val) => val === JOB_CONCURRENT_ALLOW ? 'success' : 'warning';
/** 任务并发执行状态文本 */
const getConcurrentLabel = (val) => val === JOB_CONCURRENT_ALLOW ? '允许' : '禁止';
/** 任务状态切换后提示文本 */
const getStatusToggleMessage = (val) => val === JOB_STATUS_NORMAL ? '任务已启用' : '任务已暂停';
...
__VLS_155.slots.default;
{
    ...
    const __VLS_157 = __VLS_asFunctionalComponent(__VLS_156, new __VLS_156({
        type: (__VLS_ctx.getConcurrentTagType(row.concurrent)),
    }));
    const __VLS_158 = __VLS_157({
        type: (__VLS_ctx.getConcurrentTagType(row.concurrent)),
    }, ...__VLS_functionalComponentArgsRest(__VLS_157));
    __VLS_159.slots.default;
    (__VLS_ctx.getConcurrentLabel(row.concurrent));
    var __VLS_159;
}
var __VLS_155;
...
__VLS_163.slots.default;
{
    ...
    const __VLS_165 = __VLS_asFunctionalComponent(__VLS_164, new __VLS_164({
        ...
        activeValue: (__VLS_ctx.JOB_STATUS_NORMAL),
        inactiveValue: (__VLS_ctx.JOB_STATUS_DISABLED),
    }));
...
const __VLS_self = (await import('vue')).defineComponent({
    setup() {
        return {
            ...
            JOB_STATUS_NORMAL: JOB_STATUS_NORMAL,
            JOB_STATUS_DISABLED: JOB_STATUS_DISABLED,
            getConcurrentTagType: getConcurrentTagType,
            getConcurrentLabel: getConcurrentLabel,
            loading: loading,
            tableData: tableData,
            total: total,
