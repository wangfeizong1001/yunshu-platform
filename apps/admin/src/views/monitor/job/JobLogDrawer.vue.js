...
const handleClean = async () => {
  try {
    await ElMessageBox.confirm('确认清空该任务的所有日志吗？此操作不可恢复！', '警告', {
      type: 'warning',
    });
...
var __VLS_104;
var __VLS_3;
/** @type {__VLS_StyleScopedClasses['search-form']} */ /** @type {__VLS_StyleScopedClasses['toolbar']} */ /** @type {__VLS_StyleScopedClasses['log-table']} */ /** @type {__VLS_StyleScopedClasses['error-text']} */ /** @type {__VLS_StyleScopedClasses['pagination-container']} */ var __VLS_dollars;
