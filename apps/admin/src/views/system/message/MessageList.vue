<template>
  <div class="message-list">
    ...
    <el-card shadow="never" class="table-card">
      <template #header>
        <div class="table-header">
          <div class="left">
            <el-button v-has-permi="['system:message:add']" type="primary" :icon="Plus" @click="handleSend">发消息</el-button>
            <el-button v-has-permi="['system:message:edit']" type="warning" :icon="DocumentChecked" @click="handleMarkAllRead">全部已读</el-button>
            <el-button v-has-permi="['system:message:remove']" type="danger" :icon="Delete" :disabled="!selectedRows.length" @click="handleBatchDelete">批量删除</el-button>
          </div>
          <div class="right">
      ...
      <el-table v-loading="loading" :data="messageList" stripe border @selection-change="handleSelectionChange">
    ...
    <MessageDetail v-model="detailVisible" :message-id="currentMessageId" @mark-read="handleMarkReadById" />
  </div>
</template>
