...
if (__VLS_ctx.messageInfo) {
  ...
  if (__VLS_ctx.messageInfo.status === '0') {
...
}
{
  ...
  var __VLS_56;
  if (__VLS_ctx.messageInfo && __VLS_ctx.messageInfo.status === '0') {
...
var __VLS_3;
/** @type {__VLS_StyleScopedClasses['message-detail']} */ /** @type {__VLS_StyleScopedClasses['detail-title']} */ /** @type {__VLS_StyleScopedClasses['detail-content']} */ /** @type {__VLS_StyleScopedClasses['dialog-footer']} */ var __VLS_dollars;
