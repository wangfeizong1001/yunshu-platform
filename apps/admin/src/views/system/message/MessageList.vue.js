...
/** 消息状态 tag 类型 */
const getMsgStatusTagType = (val) => val === MSG_STATUS_UNREAD ? 'primary' : 'info';
/** 消息状态文本 */
...
__VLS_171.slots.default;
{
    ...
    const __VLS_173 = __VLS_asFunctionalComponent(__VLS_172, new __VLS_172({
        type: (__VLS_ctx.getMsgStatusTagType(row.status)),
    }));
    const __VLS_174 = __VLS_173({
        type: (__VLS_ctx.getMsgStatusTagType(row.status)),
    }, ...__VLS_functionalComponentArgsRest(__VLS_173));
    __VLS_175.slots.default;
    (__VLS_ctx.getMsgStatusLabel(row.status));
    var __VLS_175;
}
var __VLS_171;
...
__VLS_179.slots.default;
{
    ...
    var __VLS_183;
    if (row.status === __VLS_ctx.MSG_STATUS_UNREAD) {
...
const __VLS_self = (await import('vue')).defineComponent({
    setup() {
        return {
            ...
            getMsgStatusTagType: getMsgStatusTagType,
            getMsgStatusLabel: getMsgStatusLabel,
            loading: loading,
