...
/** 岗位状态 tag 类型 */
const getPostStatusTagType = (val) => val === POST_STATUS_NORMAL ? 'success' : 'danger';
/** 岗位状态文本 */
const getPostStatusLabel = (val) => val === POST_STATUS_NORMAL ? '正常' : '停用';
// 状态
...
__VLS_107.slots.default;
{
    ...
    const __VLS_109 = __VLS_asFunctionalComponent(__VLS_108, new __VLS_108({
        type: (__VLS_ctx.getPostStatusTagType(row.status)),
    }));
    const __VLS_110 = __VLS_109({
        type: (__VLS_ctx.getPostStatusTagType(row.status)),
    }, ...__VLS_functionalComponentArgsRest(__VLS_109));
    __VLS_111.slots.default;
    (__VLS_ctx.getPostStatusLabel(row.status));
    var __VLS_111;
}
var __VLS_107;
...
__VLS_123.slots.default;
{
    ...
    __VLS_asFunctionalDirective(__VLS_directives.vHasPermi)(null, { ...__VLS_directiveBindingRestFields, value: (['system:post:delete']) }, null, null);
...
// @ts-ignore
const __VLS_149 = __VLS_asFunctionalComponent(PostForm, new PostForm({
    ...{ 'onRefresh': {} },
...
const __VLS_self = (await import('vue')).defineComponent({
    setup() {
        return {
            ...
            Plus: Plus,
            PostForm: PostForm,
            getPostStatusTagType: getPostStatusTagType,
            getPostStatusLabel: getPostStatusLabel,
            loading: loading,
            postList: postList,
            total: total,
