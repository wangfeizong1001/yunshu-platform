...
/** @type {__VLS_StyleScopedClasses['component-panel']} */ /** @type {__VLS_StyleScopedClasses['design-panel']} */ /** @type {__VLS_StyleScopedClasses['props-panel']} */ /** @type {__VLS_StyleScopedClasses['empty-tip']} */ // CSS variable injection
...
/** @type {[typeof __VLS_components.Draggable, typeof __VLS_components.draggable, typeof __VLS_components.Draggable, typeof __VLS_components.draggable, ]} */ // @ts-ignore
...
__VLS_35.slots.default;
{
  ...
  const __VLS_40 = {}.Rank;
  /** @type {[typeof __VLS_components.Rank, ]} */ // @ts-ignore
...
if (__VLS_ctx.selectedComponent) {
  ...
  if (['radio', 'checkbox', 'select'].includes(__VLS_ctx.selectedComponent.type)) {
    ...
    for (const [option, index] of __VLS_getVForSourceType(__VLS_ctx.selectedComponent.options)) {
      ...
      const __VLS_151 = {
        onClick: (...[$event]) => {
          if (!__VLS_ctx.selectedComponent) return;
          if (!['radio', 'checkbox', 'select'].includes(__VLS_ctx.selectedComponent.type)) return;
...
/** @type {__VLS_StyleScopedClasses['form-design']} */ /** @type {__VLS_StyleScopedClasses['toolbar']} */ /** @type {__VLS_StyleScopedClasses['left']} */ /** @type {__VLS_StyleScopedClasses['form-title']} */ /** @type {__VLS_StyleScopedClasses['right']} */ /** @type {__VLS_StyleScopedClasses['design-container']} */ /** @type {__VLS_StyleScopedClasses['component-panel']} */ /** @type {__VLS_StyleScopedClasses['panel-title']} */ /** @type {__VLS_StyleScopedClasses['component-list']} */ /** @type {__VLS_StyleScopedClasses['component-item']} */ /** @type {__VLS_StyleScopedClasses['component-icon']} */ /** @type {__VLS_StyleScopedClasses['component-name']} */ /** @type {__VLS_StyleScopedClasses['design-panel']} */ /** @type {__VLS_StyleScopedClasses['panel-title']} */ /** @type {__VLS_StyleScopedClasses['design-area']} */ /** @type {__VLS_StyleScopedClasses['components-container']} */ /** @type {__VLS_StyleScopedClasses['form-component']} */ /** @type {__VLS_StyleScopedClasses['component-header']} */ /** @type {__VLS_StyleScopedClasses['drag-handle']} */ /** @type {__VLS_StyleScopedClasses['component-label']} */ /** @type {__VLS_StyleScopedClasses['component-actions']} */ /** @type {__VLS_StyleScopedClasses['action-icon']} */ /** @type {__VLS_StyleScopedClasses['action-icon']} */ /** @type {__VLS_StyleScopedClasses['delete']} */ /** @type {__VLS_StyleScopedClasses['component-preview']} */ /** @type {__VLS_StyleScopedClasses['empty-tip']} */ /** @type {__VLS_StyleScopedClasses['props-panel']} */ /** @type {__VLS_StyleScopedClasses['panel-title']} */ /** @type {__VLS_StyleScopedClasses['props-content']} */ /** @type {__VLS_StyleScopedClasses['options-list']} */ /** @type {__VLS_StyleScopedClasses['option-item']} */ /** @type {__VLS_StyleScopedClasses['option-delete']} */ /** @type {__VLS_StyleScopedClasses['empty-tip']} */ var __VLS_dollars;
