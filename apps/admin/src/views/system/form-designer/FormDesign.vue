              ...
              <div class="form-component" :class="{ active: selectedComponent?.id === element.id }">
                <div class="component-header">
                  ...
                  <div class="component-actions">
                    ...
                    <el-icon class="action-icon delete" @click.stop="handleDeleteComponent(element.id)">
                      <Delete />
                    </el-icon>
                  </div>
                </div>
        ...
        <div v-if="selectedComponent" class="props-content">
          <el-form :model="selectedComponent" label-width="100px">
            ...
            <el-form-item label="默认值">
              <el-input v-if="selectedComponent.type !== 'checkbox'" v-model="selectedComponent.defaultValue" placeholder="请输入默认值" />
...
async function fetchFormInfo() {
  ...
  try {
    ...
    formInfo.value = res.data as unknown as FormInfo | null
    components.value = (res.data as unknown as FormInfo)?.components || []
  } catch (error) {
