...
import { getFormPage, getForm, addForm, updateForm, deleteForm, batchDeleteForm, copyForm, publishForm, stopForm } from '@/api/system/form.api';
const router = useRouter();
// ========== 状态常量（与后端约定字段值） ==========
const FORM_STATUS_DRAFT = '0';
const FORM_STATUS_PUBLISHED = '1';
/** 表单状态 tag 类型 */
const getFormStatusTagType = (val) => val === FORM_STATUS_PUBLISHED ? 'success' : 'info';
/** 表单状态文本 */
const getFormStatusLabel = (val) => val === FORM_STATUS_PUBLISHED ? '已发布' : '草稿';
// 状态
...
__VLS_115.slots.default;
{
    ...
    const __VLS_117 = __VLS_asFunctionalComponent(__VLS_116, new __VLS_116({
        type: (__VLS_ctx.getFormStatusTagType(row.status)),
    }));
    const __VLS_118 = __VLS_117({
        type: (__VLS_ctx.getFormStatusTagType(row.status)),
    }, ...__VLS_functionalComponentArgsRest(__VLS_117));
    __VLS_119.slots.default;
    (__VLS_ctx.getFormStatusLabel(row.status));
    var __VLS_119;
}
var __VLS_115;
...
__VLS_131.slots.default;
{
    ...
    var __VLS_143;
    if (row.status === __VLS_ctx.FORM_STATUS_DRAFT) {
    ...
    if (row.status === __VLS_ctx.FORM_STATUS_PUBLISHED) {
...
var __VLS_200;
/** @type {__VLS_StyleScopedClasses['form-list']} */ ;
...
const __VLS_self = (await import('vue')).defineComponent({
    setup() {
        return {
            ...
            Plus: Plus,
            Delete: Delete,
            FORM_STATUS_DRAFT: FORM_STATUS_DRAFT,
            FORM_STATUS_PUBLISHED: FORM_STATUS_PUBLISHED,
            getFormStatusTagType: getFormStatusTagType,
            getFormStatusLabel: getFormStatusLabel,
            loading: loading,
            formList: formList,
            total: total,
