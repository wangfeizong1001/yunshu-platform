...
const getThirdLogStatusTagType = (val) => val === THIRD_LOG_SUCCESS ? 'success' : 'danger';
const getThirdLogStatusLabel = (val) => val === THIRD_LOG_SUCCESS ? '成功' : '失败';
// 状态
...
__VLS_143.slots.default;
{
    ...
    const __VLS_145 = __VLS_asFunctionalComponent(__VLS_144, new __VLS_144({
        type: (__VLS_ctx.getThirdLogStatusTagType(row.status)),
        size: "small",
    }));
    ...
    (__VLS_ctx.getThirdLogStatusLabel(row.status));
    var __VLS_147;
}
var __VLS_143;
...
var __VLS_159;
var __VLS_91;
/** @type {__VLS_StyleScopedClasses['third-log']} */ ;
...
const __VLS_self = (await import('vue')).defineComponent({
    setup() {
        return {
            Search: Search,
            Refresh: Refresh,
            getThirdLogStatusTagType: getThirdLogStatusTagType,
            getThirdLogStatusLabel: getThirdLogStatusLabel,
            loading: loading,
            logList: logList,
            total: total,
            dateRange: dateRange,
