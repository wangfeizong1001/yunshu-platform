...
/** 知识库状态 tag 类型 */
const getKnowledgeStatusTagType = (val) => val === KNOWLEDGE_STATUS_PUBLISHED ? 'success' : 'info';
/** 知识库状态文本 */
const getKnowledgeStatusLabel = (val) => val === KNOWLEDGE_STATUS_PUBLISHED ? '已发布' : '草稿';
// 状态
...
__VLS_131.slots.default;
{
    ...
    const __VLS_133 = __VLS_asFunctionalComponent(__VLS_132, new __VLS_132({
        type: (__VLS_ctx.getKnowledgeStatusTagType(row.status)),
    }));
    const __VLS_134 = __VLS_133({
        type: (__VLS_ctx.getKnowledgeStatusTagType(row.status)),
    }, ...__VLS_functionalComponentArgsRest(__VLS_133));
    __VLS_135.slots.default;
    (__VLS_ctx.getKnowledgeStatusLabel(row.status));
    var __VLS_135;
}
var __VLS_131;
...
__VLS_151.slots.default;
{
    ...
    var __VLS_163;
    if (row.status === __VLS_ctx.KNOWLEDGE_STATUS_DRAFT) {
    ...
    if (row.status === __VLS_ctx.KNOWLEDGE_STATUS_PUBLISHED) {
...
const __VLS_self = (await import('vue')).defineComponent({
    setup() {
        return {
            ...
            KNOWLEDGE_STATUS_PUBLISHED: KNOWLEDGE_STATUS_PUBLISHED,
            KNOWLEDGE_STATUS_DRAFT: KNOWLEDGE_STATUS_DRAFT,
            getKnowledgeStatusTagType: getKnowledgeStatusTagType,
            getKnowledgeStatusLabel: getKnowledgeStatusLabel,
            loading: loading,
