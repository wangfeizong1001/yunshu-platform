...
if (__VLS_ctx.knowledgeData) {
    ...
    const __VLS_18 = __VLS_asFunctionalComponent(__VLS_17, new __VLS_17({
        type: (__VLS_ctx.getKnowledgeStatusTagType(__VLS_ctx.knowledgeData.status)),
        size: "small",
    }));
    ...
    (__VLS_ctx.getKnowledgeStatusLabel(__VLS_ctx.knowledgeData.status));
    var __VLS_20;
    ...
    // @ts-ignore
    const __VLS_49 = __VLS_asFunctionalComponent(SafeHtml, new SafeHtml({
        html: (__VLS_ctx.knowledgeData.content || ''),
        customClass: "content-wrapper",
    }));
