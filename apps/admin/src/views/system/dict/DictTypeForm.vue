...
async function handleSubmit() {
  try {
    ...
    if (isEdit.value) {
      await updateDictType({ dictId: props.dictTypeData!.dictId, ...formData.value } as Record<string, unknown>)
      ElMessage.success('修改成功')
    } else {
      await addDictType(formData.value as Record<string, unknown>)
