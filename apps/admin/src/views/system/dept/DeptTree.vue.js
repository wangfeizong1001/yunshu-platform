...
/** 部门状态 tag 类型 */
const getDeptStatusTagType = (val) => val === DEPT_STATUS_NORMAL ? 'success' : 'danger';
/** 部门状态文本 */
const getDeptStatusLabel = (val) => val === DEPT_STATUS_NORMAL ? '正常' : '停用';
// 状态
...
__VLS_103.slots.default;
{
    ...
    const __VLS_105 = __VLS_asFunctionalComponent(__VLS_104, new __VLS_104({
        type: (__VLS_ctx.getDeptStatusTagType(row.status)),
    }));
    const __VLS_106 = __VLS_105({
        type: (__VLS_ctx.getDeptStatusTagType(row.status)),
    }, ...__VLS_functionalComponentArgsRest(__VLS_105));
    __VLS_107.slots.default;
    (__VLS_ctx.getDeptStatusLabel(row.status));
    var __VLS_107;
}
var __VLS_103;
...
const __VLS_self = (await import('vue')).defineComponent({
    setup() {
        return {
            ...
            Plus: Plus,
            DeptForm: DeptForm,
            getDeptStatusTagType: getDeptStatusTagType,
            getDeptStatusLabel: getDeptStatusLabel,
            loading: loading,
            deptList: deptList,
