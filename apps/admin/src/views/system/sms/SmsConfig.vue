<template>
  <div class="sms-config">
    ...
    <!-- 模板表单弹窗 -->
    <el-dialog v-model="templateVisible" :title="templateForm.id ? '编辑模板' : '新增模板'" width="600px" append-to-body>
      <el-form ref="templateFormRef" :model="templateForm" :rules="templateRules" label-width="100px">
        ...
        <el-form-item label="备注" prop="remark">
          <el-input v-model="templateForm.remark" type="textarea" :rows="2" placeholder="请输入备注" />
        </el-form-item>
      </el-form>
      <template #footer>
        <el-button @click="templateVisible = false">取消</el-button>
        <el-button type="primary" :loading="templateLoading" @click="handleSaveTemplate">保存</el-button>
      </template>
    </el-dialog>
    ...
    <el-dialog v-model="sendVisible" title="发送短信" width="500px" append-to-body>
      <el-form ref="sendFormRef" :model="sendForm" :rules="sendRules" label-width="100px">
        ...
        <el-form-item label="参数">
          <el-input v-model="sendParams" type="textarea" :rows="3" placeholder="请输入参数，JSON格式，如: {&quot;code&quot;:&quot;123456&quot;}" />
        </el-form-item>
      </el-form>
      <template #footer>
