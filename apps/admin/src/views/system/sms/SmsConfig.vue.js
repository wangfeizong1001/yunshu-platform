...
const getSmsStatusTagType = (val) => val === SMS_ENABLED ? 'success' : 'danger';
const getSmsStatusLabel = (val) => val === SMS_ENABLED ? '启用' : '禁用';
// 配置相关
...
const __VLS_37 = __VLS_asFunctionalComponent(__VLS_36, new __VLS_36({
    type: (__VLS_ctx.getSmsStatusTagType(__VLS_ctx.config.status)),
}));
const __VLS_38 = __VLS_37({
    type: (__VLS_ctx.getSmsStatusTagType(__VLS_ctx.config.status)),
}, ...__VLS_functionalComponentArgsRest(__VLS_37));
__VLS_39.slots.default;
(__VLS_ctx.getSmsStatusLabel(__VLS_ctx.config.status));
var __VLS_39;
var __VLS_35;
var __VLS_15;
var __VLS_3;
...
for (const [item] of __VLS_getVForSourceType((__VLS_ctx.templateList.filter(t => t.status === __VLS_ctx.SMS_ENABLED)))) {
