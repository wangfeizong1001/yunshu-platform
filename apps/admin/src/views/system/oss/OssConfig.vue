<template>
  <el-dialog v-model="visible" title="OSS 配置" width="900px" append-to-body @close="handleClose">
    <el-tabs v-model="activeTab" type="border-card">
      <el-tab-pane label="阿里云 OSS" name="aliyun">
        <el-form ref="aliyunFormRef" :model="aliyunForm" :rules="aliyunRules" label-width="140px">
          <el-form-item label="存储类型">
            <el-input v-model="aliyunForm.typeName" disabled />
          </el-form-item>
          <el-form-item label="AccessKey" prop="accessKey">
            <el-input v-model="aliyunForm.accessKey" placeholder="请输入 AccessKey" show-password />
          </el-form-item>
          <el-form-item label="SecretKey" prop="secretKey">
            <el-input v-model="aliyunForm.secretKey" placeholder="请输入 SecretKey" show-password />
          </el-form-item>
        ...
        <div class="dialog-footer">
          <el-button
            ...
            @click="handleTestConnection('aliyun')"
          >
            测试连接
          </el-button>
      ...
      <el-tab-pane label="腾讯云 COS" name="qcloud">
        <el-form ref="qcloudFormRef" :model="qcloudForm" :rules="qcloudRules" label-width="140px">
          <el-form-item label="存储类型">
            <el-input v-model="qcloudForm.typeName" disabled />
          </el-form-item>
          <el-form-item label="SecretId" prop="accessKey">
            <el-input v-model="qcloudForm.accessKey" placeholder="请输入 SecretId" show-password />
          </el-form-item>
          <el-form-item label="SecretKey" prop="secretKey">
            <el-input v-model="qcloudForm.secretKey" placeholder="请输入 SecretKey" show-password />
          </el-form-item>
          <el-form-item label="Bucket" prop="bucket">
        ...
        <div class="dialog-footer">
          <el-button
            type="primary"
            :loading="qcloudLoading"
            @click="handleTestConnection('qcloud')"
          >
            测试连接
          </el-button>
      ...
      <el-tab-pane label="七牛云存储" name="qiniu">
        <el-form ref="qiniuFormRef" :model="qiniuForm" :rules="qiniuRules" label-width="140px">
          <el-form-item label="存储类型">
            <el-input v-model="qiniuForm.typeName" disabled />
          </el-form-item>
          <el-form-item label="AccessKey" prop="accessKey">
            <el-input v-model="qiniuForm.accessKey" placeholder="请输入 AccessKey" show-password />
          </el-form-item>
          <el-form-item label="SecretKey" prop="secretKey">
            <el-input v-model="qiniuForm.secretKey" placeholder="请输入 SecretKey" show-password />
          </el-form-item>
          <el-form-item label="Bucket" prop="bucket">
      ...
      <el-tab-pane label="本地存储" name="local">
        <el-form ref="localFormRef" :model="localForm" label-width="140px">
          <el-form-item label="存储类型">
