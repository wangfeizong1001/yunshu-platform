...
export function useSearch(config) {
    const { indexConfig, initialDocuments = [], debounceDelay = 300, maxHistorySize = 10, autoSaveHistory = true, historyStorageKey = 'search_history', enableSuggestions = true, maxResults = 50 } = config;
    // 搜索索引实例
