...
/** 导出默认实例的方法 */
export declare function subscribe<T = unknown>(topic: string, callback: MessageCallback<T>, once?: boolean): string;
export declare function subscribeOnce<T = unknown>(topic: string, callback: MessageCallback<T>): string;
