...
- Name: system.spec.ts >> 系统管理 - 部门管理 >> 部门树存在
- Location: playwright/tests/system.spec.ts:123:3
...
Locator: locator('.el-tree, [class*="tree"]').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.el-tree, [class*="tree"]').first()
